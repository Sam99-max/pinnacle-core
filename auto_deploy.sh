...
curl -X POST https://8881269e-c2b0-4992-a9b1-7bb7dbd0d8f2.deployments.pythagora.ai/api/notify \
  ...
  -d '{"status": "build_complete", "source": "pinnacle-core-1"}' || echo "Remote notification failed."
...
# rsync -avz --exclude='.git' ./ user@zenith-xas.com:/var/www/pinnacle-core-1/
